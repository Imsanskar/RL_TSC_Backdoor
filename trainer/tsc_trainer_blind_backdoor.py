...
@Registry.register_trainer("tsc_blind_backdoor")
class TSCTrainerBlindBackdoor(BaseTrainer):
    '''
...
@Registry.register_trainer("tsc_test_blind_backdoor")
class TSCTesterBlindBackdoor(TSCTrainerBlindBackdoor):
    def test(self):
        '''
        test
        Test process. Evaluate model performance.
